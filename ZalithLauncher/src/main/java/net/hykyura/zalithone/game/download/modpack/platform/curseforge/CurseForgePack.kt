...
package net.hykyura.zalithone.game.download.modpack.platform.curseforge
...
import net.hykyura.zalithone.game.download.assets.platform.curseforge.models.fixedFileUrl
import net.hykyura.zalithone.game.download.assets.platform.curseforge.models.getPlatformClassesOrNull
import net.hykyura.zalithone.game.download.assets.platform.curseforge.models.getSHA1
import net.hykyura.zalithone.game.download.assets.platform.mcim.mapMCIMMirrorUrls
import net.hykyura.zalithone.game.download.assets.platform.mirroredCurseForgeSource
import net.hykyura.zalithone.game.download.assets.platform.mirroredPlatformSearcher
import net.hykyura.zalithone.game.download.modpack.install.ModFile
import net.hykyura.zalithone.game.download.modpack.install.ModPackInfo
import net.hykyura.zalithone.game.download.modpack.install.ModPackInfoTask
import net.hykyura.zalithone.game.download.modpack.platform.PackPlatform
