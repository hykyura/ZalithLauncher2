...
package net.hykyura.zalithone.game.version.download
...
import net.hykyura.zalithone.game.path.getResourcesHome
import net.hykyura.zalithone.game.path.getVersionsHome
import net.hykyura.zalithone.game.versioninfo.MinecraftVersions
import net.hykyura.zalithone.game.versioninfo.models.AssetIndexJson
import net.hykyura.zalithone.game.versioninfo.models.GameManifest
import net.hykyura.zalithone.game.versioninfo.models.VersionManifest.Version
