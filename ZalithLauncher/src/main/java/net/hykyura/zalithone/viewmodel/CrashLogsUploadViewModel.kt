...
import net.hykyura.zalithone.crashlogs.AbstractAPI
import net.hykyura.zalithone.crashlogs.LinkNotFoundException
import net.hykyura.zalithone.crashlogs.MCLogsResponse
