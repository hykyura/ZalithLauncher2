...
package net.hykyura.zalithone.game.account.yggdrasil
...
import net.hykyura.zalithone.game.account.microsoft.MinecraftProfileException.ExceptionStatus.PROFILE_NOT_EXISTS
