...
import net.hykyura.zalithone.SplashException
import net.hykyura.zalithone.components.Components
import net.hykyura.zalithone.components.InstallableItem
import net.hykyura.zalithone.components.UnpackComponentsTask
import net.hykyura.zalithone.components.jre.Jre
import net.hykyura.zalithone.components.jre.UnpackJnaTask
import net.hykyura.zalithone.components.jre.UnpackJreTask
import net.hykyura.zalithone.setting.AllSettings
import net.hykyura.zalithone.ui.base.BaseAppCompatActivity
import net.hykyura.zalithone.ui.screens.splash.SplashScreen
