...
import net.hykyura.zalithone.game.download.assets.platform.curseforge.models.CurseForgeModLoader
import net.hykyura.zalithone.game.download.assets.platform.getProjectByVersion
import net.hykyura.zalithone.game.download.assets.platform.getVersionByLocalFile
import net.hykyura.zalithone.game.download.assets.platform.modrinth.models.ModrinthModLoaderCategory
import net.hykyura.zalithone.game.download.assets.platform.modrinth.models.ModrinthVersion
import net.hykyura.zalithone.game.download.assets.utils.ModTranslations
import net.hykyura.zalithone.game.download.assets.utils.getMcMod
import net.hykyura.zalithone.game.download.assets.utils.getTranslations
import net.hykyura.zalithone.utils.file.calculateFileSha1
